...
import { deleteOrganization, insertOrganization, updateOrganization } from "@/features/organizations/db/organization";
...
export const clerkOrganizationUser = inngest.createFunction(
    ...
    await step.run("verify-webhook", async () => {
     ...
     await step.run("create-organization", async () => {
      ...
      await insertOrganization({
        ...
        updatedAt: new Date(orgData.created_at),
      });
