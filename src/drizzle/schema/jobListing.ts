import { boolean, integer, pgEnum, pgTable, text, varchar,timestamp, index } from "drizzle-orm/pg-core";
...
export const jobListingReferences = relations(JobListingTable,({one,many})=>({
    organization:one(OrganizationTable,{fields:[JobListingTable.organizationId],
